const About = () => {
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-lg text-gray-300 space-y-6"> {/* Aumentamos o espaçamento entre parágrafos */}
        <p>
          [Eu sou estudante de engenharia de software pela Universidade Positivo(UP), e estou no oitavo período! Venho estudando desde então linguagens de programação, bancos de dados, estruturas de aplicações, etc... Nesse meio tempo aprendi a trabalhar com metodologias ágeis de produção.]
        </p>
        <p>
