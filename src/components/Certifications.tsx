...
const Certifications = () => {
  ...
  const certificates = isEnglish
    ? [
        {
          title: 'Programming Logic and Algorithms in C',
          issuer: 'Udemy',
          date: 'August 2025',
    ...
    : [
        {
          title: 'Lógica de Programação e Algoritmos em C',
          issuer: 'Udemy',
          date: 'Agosto 2025',
          credentialLink: 'https://www.udemy.com/certificate/UC-b5de53d8-344c-4e29-a476-d1ce3136d175',
          logoPath: '/logos/udemy-logo.png',
  ...
  const heading = isEnglish
    ? {
        badge: 'certificates',
        title: 'Learning paths that refresh my toolbox',
      }
    : {
        badge: 'certificados',
        title: 'Aprendizados que atualizam minha caixa de ferramentas',
      };
      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
        {certificates.map((certificate) => (
          <CertificateItem
            ...
            {...certificate}
            issuedLabel={labels.issuedLabel}
            credentialLabel={labels.credentialLabel}
          />
        ))}
      </div>
    </section>
